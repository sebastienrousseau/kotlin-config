...
This document describes how @sebastienrousseau/kotlin-config is run: who decides what, how
...
@sebastienrousseau/kotlin-config is **maintainer-led**. As of the current release line it has a single
