...
%global npm_bare      kotlin-config
%global sitelib       %{_prefix}/lib/node_modules

Name:           nodejs-sebastienrousseau-kotlin-config
Version:        0.0.7
Release:        1%{?dist}
Summary:        Shareable Kotlin configuration providing standardized ktlint and Detekt rules adhering to modern 2026 standards

License:        Apache-2.0 OR MIT
URL:            https://github.com/sebastienrousseau/kotlin-config
Source0:        %{name}-%{version}.tar.gz
BuildArch:      noarch
Requires:       nodejs >= 20

%description
@sebastienrousseau/kotlin-config is a shareable configuration preset with no runtime
...
install -pm 0644 detekt.yml %{buildroot}%{sitelib}/%{npm_scope}/%{npm_bare}/
