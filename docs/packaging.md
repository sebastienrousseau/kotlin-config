...
# Packaging @sebastienrousseau/kotlin-config
...
-  `detekt.yml` — the tool-native preset file(s)
...
| :----- | :--- | :---------- |
| Debian | [`pkg/deb/`](../pkg/deb) | `/usr/share/nodejs/@sebastienrousseau/kotlin-config/` |
| RPM | [`pkg/rpm/`](../pkg/rpm) | `/usr/lib/node_modules/@sebastienrousseau/kotlin-config/` |
| Arch | [`pkg/aur/PKGBUILD`](../pkg/aur/PKGBUILD) | `/usr/lib/node_modules/@sebastienrousseau/kotlin-config/` |
| Homebrew | [`pkg/brew/kotlin-config.rb`](../pkg/brew/kotlin-config.rb) | formula cellar |
| Nix | [`pkg/nix/flake.nix`](../pkg/nix/flake.nix) | `$out/lib/node_modules/@sebastienrousseau/kotlin-config/` |
