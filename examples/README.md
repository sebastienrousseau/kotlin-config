# `@sebastienrousseau/kotlin-config` Examples Catalog

This directory provides runnable, standalone examples covering **100% of the functionalities and features** provided by `@sebastienrousseau/kotlin-config`.
...
- [x] **detekt.yml**: Standardized rule preset
