...
- Added a `native-validate` CI job that installs the real toolchain (detekt) and validates the shipped presets.
- Corrected the OpenSSF Best Practices badge, which pointed at another project.
## [0.0.1] - 2026-09-09

### Added

- Initial release of `@sebastienrousseau/kotlin-config` conforming to REPO-STANDARD.
- Standardized Kotlin configuration presets: `.editorconfig`, `detekt.yml`.
